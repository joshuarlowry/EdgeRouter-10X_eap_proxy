...
On the Dashboard tab click the Actions next to switch0 and config.
Set the Address dropdown to "Manually define IP address" 
...
```
set interfaces ethernet eth0 vif 0 dhcpv6-pd duidxx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:xx:'save;commit
```
